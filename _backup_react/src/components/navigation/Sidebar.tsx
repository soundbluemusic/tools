  ...
  return (
    <aside className="sidebar">
      <nav className="sidebar-nav">
        {/* Home */}
        <NavLink to="/" className={`sidebar-item ${isActive('/') ? 'active' : ''}`}>
          ...
          <span className="sidebar-label">{language === 'ko' ? '홈' : 'Home'}</span>
        </NavLink>
        ...
        <NavLink to="/sitemap" className={`sidebar-item ${isActive('/sitemap') ? 'active' : ''}`}>
          ...
          <span className="sidebar-label">{language === 'ko' ? '메뉴' : 'Menu'}</span>
        </NavLink>
      </nav>
    </aside>
  );
