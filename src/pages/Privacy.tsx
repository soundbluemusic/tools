...
/**
 * Privacy Policy Page
 * Discloses data collection and usage practices
 */
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <section className="mb-6">
            ...
            <ul className="mb-3 list-disc pl-6">
              <li className="mb-2 text-base leading-relaxed text-text-secondary">
                <strong className="text-text-primary">언어 설정:</strong>{' '}
                사용자가 선택한 언어(한국어/영어)
              </li>
              <li className="mb-2 text-base leading-relaxed text-text-secondary">
                <strong className="text-text-primary">테마 설정:</strong>{' '}
          ...
          <section className="mb-6">
            ...
            <p className="mb-3 text-base leading-relaxed text-text-secondary">
              ...
              제공을 위해 기본적인 연결 정보(IP 주소, 브라우저 유형 등)를 처리할
              수 있습니다.{' '}
              <a
          ...
          <section className="mb-6">
            ...
            <p className="mb-3 text-base leading-relaxed text-text-secondary">
              본 개인정보 처리방침은 법률 변경이나 서비스 변경에 따라 수정될 수
              있습니다. 중요한 변경 사항이 있을 경우 서비스 내에서 공지합니다.
            </p>
          </section>
    ...
    <PageLayout title={title} description={description}>
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-6">
          ...
          <p className="mb-3 text-base leading-relaxed text-text-secondary">
            This Service is hosted via Cloudflare. Cloudflare may process basic
            connection information (IP address, browser type, etc.) to provide
            the service.{' '}
            <a
              href="https://www.cloudflare.com/privacypolicy/"
              target="_blank"
          ...
          <p className="mb-3 text-base leading-relaxed text-text-secondary">
            ...
            fonts, your browser connects to Google servers, and information such
            as your IP address may be transmitted to Google.{' '}
            <a
              href="https://policies.google.com/privacy"
              target="_blank"
              rel="noopener noreferrer"
