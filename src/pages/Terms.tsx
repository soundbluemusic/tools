      ...
      <PageLayout title={title} description={description}>
        <div className="mx-auto max-w-3xl">
          <section className="mb-6">
            <h2 className="mb-3 border-b border-border-secondary pb-2 text-xl font-semibold text-text-primary">
              1. 약관의 동의
            </h2>
          ...
          <section className="mb-6">
            ...
            <h3 className="mb-2 mt-4 text-lg font-medium text-text-primary">
              3.1 오픈소스 라이선스
            </h3>
            <p className="mb-3 text-base leading-relaxed text-text-secondary">
            ...
            <ul className="mb-3 list-disc pl-6">
              <li className="mb-2 text-base leading-relaxed text-text-secondary">
                <strong className="text-text-primary">브랜드:</strong> "
                {BRAND.copyrightHolder}" 및 관련 상표와 브랜드 명칭
              </li>
              <li className="mb-2 text-base leading-relaxed text-text-secondary">
                <strong className="text-text-primary">로고 및 아이콘:</strong>{' '}
                모든 로고와 브랜드 이미지
              </li>
              <li className="mb-2 text-base leading-relaxed text-text-secondary">
                <strong className="text-text-primary">시각적 자산:</strong> 모든
                그래픽 및 시각적 자산
              </li>
            </ul>
    ...
    <PageLayout title={title} description={description}>
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-6">
          ...
          <ul className="mb-3 list-disc pl-6">
            <li className="mb-2 text-base leading-relaxed text-text-secondary">
              <strong className="text-text-primary">Brand Names:</strong> "
              {BRAND.copyrightHolder}" and related trademarks
            </li>
            <li className="mb-2 text-base leading-relaxed text-text-secondary">
              <strong className="text-text-primary">Logos and Icons:</strong>{' '}
              All logos and brand imagery
            </li>
            <li className="mb-2 text-base leading-relaxed text-text-secondary">
              <strong className="text-text-primary">Visual Assets:</strong> All
