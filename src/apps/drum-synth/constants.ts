...
export const KICK_RANGES = {
  pitchStart: { min: 30, max: 200, default: 150, step: 1 },
  pitchEnd: { min: 20, max: 80, default: 40, step: 1 },
  pitchDecay: { min: 0.01, max: 0.5, default: 0.15, step: 0.01 },
  ampDecay: { min: 0.1, max: 2, default: 0.5, step: 0.01 },
  click: { min: 0, max: 100, default: 30, step: 1 },
...
export const SNARE_RANGES = {
  ...
  toneDecay: { min: 0.05, max: 0.5, default: 0.15, step: 0.01 },
  noiseDecay: { min: 0.05, max: 0.5, default: 0.2, step: 0.01 },
  noiseFilter: { min: 1000, max: 8000, default: 3000, step: 100 },
  toneMix: { min: 0, max: 100, default: 40, step: 1 },
  snappy: { min: 0, max: 100, default: 60, step: 1 },
} as const;
...
export const HIHAT_RANGES = {
  ...
  decay: { min: 0.02, max: 1, default: 0.08, step: 0.01 },
  openness: { min: 0, max: 100, default: 0, step: 1 },
  pitch: { min: 0, max: 100, default: 50, step: 1 },
  ring: { min: 0, max: 100, default: 30, step: 1 },
} as const;
...
export const CLAP_RANGES = {
  ...
  decay: { min: 0.05, max: 0.5, default: 0.15, step: 0.01 },
...
export const SYNTH_PRESETS: Record<string, AllDrumParams> = {
  classic808: {
    kick: { pitchStart: 150, pitchEnd: 40, pitchDecay: 0.15, ampDecay: 0.8, click: 20, drive: 10, tone: 0 },
    ...
    clap: { filterFreq: 1200, filterQ: 1.5, decay: 0.2, spread: 60, tone: 40, reverb: 40 },
  ...
  hardTechno: {
    kick: { pitchStart: 180, pitchEnd: 35, pitchDecay: 0.08, ampDecay: 0.4, click: 60, drive: 40, tone: 20 },
    ...
    clap: { filterFreq: 2000, filterQ: 2, decay: 0.1, spread: 30, tone: 70, reverb: 20 },
  ...
  lofi: {
    kick: { pitchStart: 100, pitchEnd: 50, pitchDecay: 0.2, ampDecay: 0.6, click: 10, drive: 5, tone: 30 },
    ...
    clap: { filterFreq: 1000, filterQ: 1, decay: 0.25, spread: 70, tone: 30, reverb: 50 },
  ...
  minimal: {
    kick: { pitchStart: 120, pitchEnd: 45, pitchDecay: 0.12, ampDecay: 0.5, click: 15, drive: 0, tone: 10 },
    ...
    clap: { filterFreq: 1400, filterQ: 1.3, decay: 0.12, spread: 45, tone: 55, reverb: 25 },
  ...
  acoustic: {
    kick: { pitchStart: 80, pitchEnd: 55, pitchDecay: 0.1, ampDecay: 0.35, click: 50, drive: 0, tone: 60 },
    ...
    clap: { filterFreq: 1800, filterQ: 1, decay: 0.18, spread: 80, tone: 45, reverb: 60 },
