/**
 * Terms of Service Page - Vanilla TypeScript
 */
import { Component, html } from '../../core';
import { languageStore } from '../../core/Store';

const BRAND_COPYRIGHT_HOLDER = 'SoundBlueMusic';
    ...
    if (language === 'ko') {
      return html`
        <div class="max-w-container-md mx-auto px-4 py-8">
          <header class="mb-8">
            <h1 class="text-3xl font-bold text-text-primary mb-2">이용약관</h1>
          ...
          <div class="mx-auto max-w-3xl">
            ...
            <section class="mb-6">
              ...
              <ul class="mb-3 list-disc pl-6">
                <li class="mb-2 text-base leading-relaxed text-text-secondary">
                  <strong class="text-text-primary">브랜드:</strong>
                  "${BRAND_COPYRIGHT_HOLDER}" 및 관련 상표와 브랜드 명칭
                </li>
                <li class="mb-2 text-base leading-relaxed text-text-secondary">
                  <strong class="text-text-primary">로고 및 아이콘:</strong>
                  모든 로고와 브랜드 이미지
                </li>
                <li class="mb-2 text-base leading-relaxed text-text-secondary">
                  <strong class="text-text-primary">시각적 자산:</strong>
                  모든 그래픽 및 시각적 자산
                </li>
              </ul>
            ...
            <section class="mb-6">
              ...
              <ul class="mb-3 list-disc pl-6">
                <li class="mb-2 text-base leading-relaxed text-text-secondary">
                  개인적 및 상업적 목적으로 자유롭게 도구 사용
                </li>
                <li class="mb-2 text-base leading-relaxed text-text-secondary">
                  코드 수정, 복사, 병합, 출판, 배포, 서브라이선스 및 판매
                </li>
                <li class="mb-2 text-base leading-relaxed text-text-secondary">
                  단, 보호된 브랜드 자산(로고, 아이콘 등)은 제외
                </li>
              </ul>
        ...
        <div class="mx-auto max-w-3xl">
          <section class="mb-6">
            ...
            <p class="mb-3 text-base leading-relaxed text-text-secondary">
              ...
              Service. If you do not agree to these terms, please discontinue
              use of the Service.
            </p>
            <p class="text-sm italic text-text-tertiary">
          ...
          <section class="mb-6">
            ...
            <p class="mb-3 text-base leading-relaxed text-text-secondary">
              ...
              productivity tools such as a metronome, QR code generator, and
              more for free.
            </p>
          </section>
          ...
          <section class="mb-6">
            ...
            <p class="mb-3 text-base leading-relaxed text-text-secondary">
              ...
              License. The full license text can be found in our GitHub
              repository.
            </p>
            ...
            <ul class="mb-3 list-disc pl-6">
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
                <strong class="text-text-primary">Brand Names:</strong>
                "${BRAND_COPYRIGHT_HOLDER}" and related trademarks
              </li>
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
                <strong class="text-text-primary">Logos and Icons:</strong>
                All logos and brand imagery
              </li>
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
                <strong class="text-text-primary">Visual Assets:</strong>
                All graphics and visual assets
              </li>
            </ul>

            <h3 class="mb-2 mt-4 text-lg font-medium text-text-primary">
              3.3 Forking Guidelines
            </h3>
            <p class="mb-3 text-base leading-relaxed text-text-secondary">
          ...
          <section class="mb-6">
            ...
            <ul class="mb-3 list-disc pl-6">
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
                Personal and commercial use of the tools
              </li>
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
            ...
            <ul class="mb-3 list-disc pl-6">
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
                Attempting to attack the service or servers
              </li>
              <li class="mb-2 text-base leading-relaxed text-text-secondary">
