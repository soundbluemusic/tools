...
export const KICK_RANGES = {
  pitchStart: { min: 60, max: 250, default: 150, step: 1 },
  pitchEnd: { min: 20, max: 80, default: 40, step: 1 },
  pitchDecay: { min: 0.01, max: 0.5, default: 0.1, step: 0.01 },
  ampDecay: { min: 0.1, max: 3, default: 0.5, step: 0.01 },
  click: { min: 0, max: 100, default: 20, step: 1 },
...
export const HIHAT_RANGES = {
  filterFreq: { min: 4000, max: 14000, default: 10000, step: 100 },
  filterQ: { min: 0.5, max: 10, default: 1.5, step: 0.1 },
  decay: { min: 0.02, max: 1, default: 0.05, step: 0.01 },
  openness: { min: 0, max: 100, default: 0, step: 1 },
  pitch: { min: 0, max: 100, default: 60, step: 1 },
...
export const CLAP_RANGES = {
  filterFreq: { min: 800, max: 3000, default: 1000, step: 50 },
  filterQ: { min: 0.3, max: 3, default: 2.0, step: 0.1 },
  decay: { min: 0.05, max: 0.6, default: 0.15, step: 0.01 },
