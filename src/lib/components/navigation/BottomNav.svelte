<script lang="ts">
  ...
  $: isMusicActive = MUSIC_APP_PATHS.some(p => $page.url.pathname.startsWith(p));
</script>

<nav class="bottom-nav">
  <!-- Home -->
  <a href="/" class="bottom-nav-item" class:active={isActive('/')}>
  ...
  <!-- Music Tools -->
  <a href="/metronome" class="bottom-nav-item" class:active={isMusicActive}>
    <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="currentColor">
      {#if isMusicActive}
  ...
  <!-- QR Code -->
  <a href="/qr" class="bottom-nav-item" class:active={isActive('/qr')}>
    <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="currentColor">
  ...
  <!-- More / Menu -->
  <a href="/sitemap" class="bottom-nav-item" class:active={isActive('/sitemap')}>
    <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="currentColor">
