    ...
    <div className="qr-generator">
      ...
      <div className="qr-section">
        <div className="qr-input-group">
          <label className="qr-label">{t.urlLabel}</label>
          <input
            type="text"
            value={url}
            ...
            className="qr-input"
          />
          <p className="qr-help">{t.urlHelp}</p>
        </div>
      </div>

      {/* Error Level Section */}
      <div className="qr-section">
        <h3 className="qr-section-title">{t.errorCorrectionLevel}</h3>
        <div className="qr-level-buttons">
          {errorLevels.map((item) => (
            ...
            >
              <span className="qr-level-letter">{item.level}</span>
              <span className="qr-level-recovery">{item.recovery}</span>
            </button>
          ))}
        </div>
        <p className="qr-help">{t.errorLevelInfo}</p>
      </div>

      {/* Color Section */}
      <div className="qr-section">
        <h3 className="qr-section-title">{t.qrCodeColor}</h3>
      ...
      <div className="qr-section">
        ...
        <p className="qr-spec">{t.transparentBg}</p>
      </div>
