/**
 * Standalone QR Generator i18n
 * Compatible with QRTranslation type from main app
 */
...
export interface StandaloneTranslations extends QRGeneratorTranslations {
  title: string;
  lightMode: string;
  darkMode: string;
  language: string;
